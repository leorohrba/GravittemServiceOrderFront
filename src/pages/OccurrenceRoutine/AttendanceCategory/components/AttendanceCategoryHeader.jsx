...
export default function AttendanceCategoryHeader({
  selectedRows,
  userPermissions,
      ...
      <Row type="flex" className="mb-5">
        {selectedRows.length === 0 ? (
          <React.Fragment>
            ...
            <Button
              type="primary"
              onClick={() => editAttendanceCategory(null)}
            >
          ...
          <React.Fragment>
            ...
            <Button
              ...
              onClick={confirmDeleteAttendanceCategory}
            >
...
AttendanceCategoryHeader.propTypes = {
  confirmDeleteAttendanceCategory: PropTypes.any,
